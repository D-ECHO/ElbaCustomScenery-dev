...
This repository includes the scripts and data that was used for generating the "Elba Custom Scenery". work*/ folders are not included for file size reasons, but they can be generated using the scripts given here.
...
To get the finished custom scenery, please see https://github.com/D-ECHO/ElbaCustomScenery
